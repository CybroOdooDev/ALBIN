"""This is user for certificates portal tree and form templates"""
# -*- coding: utf-8 -*-
################################################################################
#
...
class MyCertificates(http.Controller):
    ...
    def get_my_certificates(self):
        ...
        certificates = request.env['certificates'].search(domain)
    ...
    def get_my_certificates_form(self, cer_id):
        """Take values from certificates and render to portal form template.It also passes the id in the root for
...
class Return(portal.CustomerPortal):
    ...
    def _prepare_home_portal_values(self, counters):
        ...
        certificates = request.env['certificates'].search([('customer_id', '=', request.env.user.partner_id.id)])
